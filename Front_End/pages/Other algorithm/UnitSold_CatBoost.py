...
class UnitSold:
    ...
    def train_model(self):
        ...
        # Identify categorical features (if any are left categorical)
        # Assuming 'Season' and 'Quarter' might be treated as categorical (modify as needed)
        cat_features = ['Season', 'Quarter', 'Month', 'DayOfWeek']  # You can adjust this list
    ...
    def evaluate_model(self, Y_test, predictions):
        print("Model Evaluation (CatBoost Model)")
    ...
    def plot_results(self, data):
        ...
        plt.title("Actual vs Predicted Sales (CatBoost)")
        # plt.show()
